...
export function loadExtendConfig(): Partial<ExtendConfig> {
  const paths = [
    path.join(process.cwd(), ".md2html-skills", "md2html-markdown-to-html", "EXTEND.md"),
    path.join(
      process.env.XDG_CONFIG_HOME || path.join(homedir(), ".config"),
      "md2html-skills", "md2html-markdown-to-html", "EXTEND.md"
    ),
    path.join(homedir(), ".md2html-skills", "md2html-markdown-to-html", "EXTEND.md"),
  ];
